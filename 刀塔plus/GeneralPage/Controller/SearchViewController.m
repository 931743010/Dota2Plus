...
-(void)createSearchBar
{
    ...
    _searchBar.placeholder=@"输国服入Dota2账号ID或昵称";
...
-(void)createUI
{
    UILabel *label=[Tools createLabelWithFrame:CGRectMake(40, 200, kWidth-80, 80) text:@"您需要在DotA2客户端中打开\"共享我的比赛数据\"！" textColor:[UIColor whiteColor] textAligment:NSTextAlignmentCenter andBgColor:[UIColor clearColor] font:[UIFont boldSystemFontOfSize:16]];
    label.alpha=0.5;
...
-(void)createTitleView
{
    ...
    UILabel *lb=[Tools createLabelWithFrame:CGRectMake(kWidth-130, 10, 120, 54) text:@"搜索" textColor:[UIColor whiteColor] textAligment:NSTextAlignmentRight andBgColor:color font:[UIFont boldSystemFontOfSize:30]];
...
-(void)searchBarSearchButtonClicked:(UISearchBar *)searchBar
{
    ...
    [[MyDownloader downloader] downloadWithUrlString:urlString successBlock:^(NSData *data) {
        ...
        {
            weakSelf.alert=[[UIAlertView alloc]initWithTitle:@"错误" message:@"此账号没有开启共享比赛数据！您需要在DotA2客户端中打开”共享我的比赛数据“" delegate:self cancelButtonTitle:nil otherButtonTitles:nil, nil];
            [weakSelf.alert show];
