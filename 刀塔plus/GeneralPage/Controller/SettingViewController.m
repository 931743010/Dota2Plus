...
-(void)createTitleView
{
    ...
    UILabel *lb=[Tools createLabelWithFrame:CGRectMake(kWidth-130, 10, 120, 54) text:@"设置" textColor:[UIColor whiteColor] textAligment:NSTextAlignmentRight andBgColor:color font:[UIFont boldSystemFontOfSize:30]];
...
//        邮件主题
        [mailView setSubject:@"关于刀塔plus的意见反馈"];
//        收件人地址
...
//    //        短信内容
//            [messageView setBody:@"我正在使用\"刀塔plus\"软件,Dota2历史战绩，精彩解说，一览无余！快来看看吧！"];
//            [self presentViewController:messageView animated:YES completion:nil];
//        }
        NSString *context=@"我正在使用\"刀塔plus\"软件,Dota2历史战绩，精彩解说，一览无余！快来看看吧!";
