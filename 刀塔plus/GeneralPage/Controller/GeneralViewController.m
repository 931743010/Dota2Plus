...
//    如果为空的话，就用默认的AccountID(144629129)
...
-(void)createTitleView
{
    ...
    UILabel *lb=[Tools createLabelWithFrame:CGRectMake(kWidth-130, 10, 120, 40) text:@"战绩plus" textColor:[UIColor whiteColor] textAligment:NSTextAlignmentRight andBgColor:color font:[UIFont boldSystemFontOfSize:28]];
...
-(void)createTipLabel
{
    if(_generalDataArray.count==0)
    {
        _tipLabel=[Tools createLabelWithFrame:CGRectMake(40, 200, kWidth-80, 80) text:@"请将手机语言改为中文，搜索绑定国服Dota2账号" textColor:[UIColor whiteColor] textAligment:NSTextAlignmentCenter andBgColor:[UIColor clearColor] font:[UIFont boldSystemFontOfSize:16]];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if(tableView==_generalTableView)
    {
        ...
        if(indexPath.section==1)
        {
            ...
            RecentMatch *match=_generalDataArray[indexPath.section][indexPath.row];
